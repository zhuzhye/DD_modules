  ...
  source: new XYZ({
    ...
    tileUrlFunction: function (xyz) {
      ...
      if (z <= 5) {
        ...
        if (x == 100 || x == 1000 || x == 10000 || x == 100000 || x == 1000000 || x == 10000000) {
          xx = padLeft(9, x);
        } else {
          xx = padLeft(8, x);
        }

        if (y == 100 || y == 1000 || x == 10000 || x == 100000 || x == 1000000 || x == 10000000) {
          yy = padLeft(9, y);
        } else {
          yy = padLeft(8, y);
        }
      }
      return 'http://47.93.90.52:18002' + '/EPSG_900913_' + lev + '/' + folder + '/' + xx + '_' + yy + '.png';
